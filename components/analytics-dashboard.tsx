...
import {
  ...
  Bar,
  BarChart,
  Tooltip as RechartsTooltip, // 👈 rename this
} from "recharts";
  ...
  useEffect(() => {
    async function loadData() {
      ...
      try {
        ...
        const covidStateRewards = await fetchCSVData(
          dataUrls.covidNormalizedState
        );
        const fluRegionalRewards = await fetchCSVData(
          dataUrls.fluNormalizedRegional
        );
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            COVID-19 vs Flu distribution efficiency by region
          </CardDescription>
        </CardHeader>
        <CardContent>
          <ChartContainer
            ...
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                ...
                <Bar
                  yAxisId="left"
                  dataKey="covid"
                  fill="var(--color-covid)"
                  name="COVID-19 Reward"
                />
                <Bar
                  yAxisId="left"
                  dataKey="flu"
        ...
        <TabsContent value="covid" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Normalized rewards by state over training episodes
              </CardDescription>
            </CardHeader>
            <CardContent>
              <ChartContainer
        ...
        <TabsContent value="flu" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Normalized rewards and loss by region
              </CardDescription>
            </CardHeader>
            <CardContent>
              <ChartContainer
