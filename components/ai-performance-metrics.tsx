  ...
  useEffect(() => {
    async function loadData() {
      ...
      try {
        ...
        const covidNormalizedData = await fetchCSVData(
          dataUrls.covidNormalizedNational
        );

        // Fetch Flu data
        const fluRawData = await fetchCSVData(dataUrls.fluRawNational);
        const fluNormalizedData = await fetchCSVData(
          dataUrls.fluNormalizedNational
        );
      ...
      <div className="space-y-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Loading reinforcement learning metrics...
            </CardDescription>
          </CardHeader>
        ...
        <TabsContent value="covid" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Reinforcement learning reward progression over training episodes
              </CardDescription>
            </CardHeader>
            <CardContent>
              <ChartContainer
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Normalized rewards and loss metrics
              </CardDescription>
            </CardHeader>
            <CardContent>
              <ChartContainer
