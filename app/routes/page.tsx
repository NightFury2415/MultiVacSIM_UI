  ...
  const fetchRouteData = async (
    ...
    try {
      const response = await fetch(
        `/api/routes?type=${type}&region=${region}&priority=${priority}`
      );
  ...
  const handleTabChange = (value: string) => {
    ...
    if (value !== "all") {
      ...
      fetchRouteData(
        ...
        appliedFilters.optimizationPriority
      );
    } else {
      setRouteType("all");
      setAppliedFilters({
        ...
        <div className="flex flex-col gap-6">
          <div className="flex flex-col gap-2">
            ...
            <p className="text-gray-500">
              View and manage AI-optimized routes for resource distribution,
              testing centers, and vaccination campaigns.
            </p>
          </div>
          ...
          {!apiKeyAvailable && (
            <Alert variant="warning">
              ...
              <AlertDescription>
                To see the actual Google Maps, please add your Google Maps API
                key to the environment variables. The environment variable
                should be named NEXT_PUBLIC_GOOGLE_MAPS_API_KEY.
              </AlertDescription>
            </Alert>
          )}
          ...
          <div className="grid gap-4 md:grid-cols-4">
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {routeData.filter((route) => route.type === "distribution")
                    .length || 24}
                </div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {routeData.filter((route) => route.type === "testing")
                    .length || 42}
                </div>
                <p className="text-xs text-gray-500">
                  Active testing locations
                </p>
              </CardContent>
            </Card>
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {routeData.filter((route) => route.type === "vaccination")
                    .length || 36}
                </div>
                <p className="text-xs text-gray-500">
          ...
          <div className="grid gap-4 grid-cols-1 lg:grid-cols-4">
            <Card className="lg:col-span-1">
              <CardHeader>
                ...
                <CardDescription>
                  Configure and filter route displays
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card className="lg:col-span-3">
              <CardHeader>
                ...
                <CardDescription>
                  Google Maps visualization of optimized routes across the USA
                </CardDescription>
              </CardHeader>
            ...
            <TabsContent value="all" className="space-y-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Complete list of all routes optimized by our AI
                  </CardDescription>
                </CardHeader>
                <CardContent>
                      ...
                      {isLoading ? (
                        ...
                        getFilteredRouteData().map((route, i) => (
                          ...
                          >
                            ...
                            <div>
                              {route.type ||
                                ["Distribution", "Testing", "Vaccination"][
                                  i % 3
                                ]}
                            </div>
                            <div>
            ...
            <TabsContent value="distribution" className="space-y-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Routes optimized for resource distribution
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="rounded-md border">
                      ...
                      {isLoading ? (
                        ...
                        getFilteredRouteData().map((route, i) => (
                          ...
                          >
                            ...
                            <div>
                              {route.subtype ||
                                ["Medical Supplies", "PPE", "Test Kits"][i % 3]}
                            </div>
                            <div>
                              {route.region ||
                                ["North", "Central", "West"][i % 3]}
                            </div>
                            <div>
                              {route.efficiency?.toFixed(1) ||
                                (88 + i).toFixed(1)}
                        ...
                        <div className="p-4 text-center">
                          No distribution routes found matching the current
                          filters.
                        </div>
                      )}
                    </div>
            ...
            <TabsContent value="testing" className="space-y-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Routes optimized for testing centers
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="rounded-md border">
                      ...
                      {isLoading ? (
                        ...
                        getFilteredRouteData().map((route, i) => (
                          ...
                          >
                            ...
                            <div>
                              {route.subtype ||
                                ["Drive-through", "Walk-in", "Mobile"][i % 3]}
                            </div>
                            <div>
                              {route.region ||
                                ["South", "East", "Central"][i % 3]}
                            </div>
                            <div>
                              {route.efficiency?.toFixed(1) ||
                                (86 + i).toFixed(1)}
                        ...
                        <div className="p-4 text-center">
                          No testing routes found matching the current filters.
                        </div>
                      )}
                    </div>
                  </div>
            ...
            <TabsContent value="vaccination" className="space-y-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Routes optimized for vaccination centers
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="rounded-md border">
                      ...
                      {isLoading ? (
                        ...
                        getFilteredRouteData().map((route, i) => (
                          ...
                          >
                            ...
                            <div>
                              {route.subtype ||
                                ["COVID-19", "Flu", "Combined"][i % 3]}
                            </div>
                            <div>
                              {route.region ||
                                ["West", "North", "South"][i % 3]}
                            </div>
                            <div>
                              {route.efficiency?.toFixed(1) ||
                                (87 + i).toFixed(1)}
                        ...
                        <div className="p-4 text-center">
                          No vaccination routes found matching the current
                          filters.
                        </div>
                      )}
                    </div>
