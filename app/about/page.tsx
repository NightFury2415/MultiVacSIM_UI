    ...
    <div className="flex flex-col min-h-screen">
        ...
        <div className="flex flex-col gap-8">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-xl text-gray-500">
              Meet the developers behind MultiVacSIM, combining expertise in
              reinforcement learning and healthcare informatics to combat
              infectious diseases.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 mt-8">
            ...
            <Card className="overflow-hidden">
              ...
              <CardHeader>
                ...
                <CardDescription className="flex items-center gap-1">
                  ...
                  <span>Full-Stack Developer & Assistant AI Engineer</span>
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <p>
                  Dev specializes in reinforcement learning algorithms and their
                  applications in healthcare. With a background in computer
                  science and artificial intelligence, he leads the development
                  of our AI models for optimizing resource allocation and route
                  planning.
                </p>
            ...
            <Card className="overflow-hidden">
              ...
              <CardHeader>
                ...
                <CardDescription className="flex items-center gap-1">
                  <Briefcase className="h-4 w-4" />
                  <span>Lead AI Engineer & Assistant Full Stack Developer</span>
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <p>
                  Naing is an expert in full-stack development with a focus on
                  healthcare applications. He architected the platform's
                  infrastructure and developed the interactive visualization
                  tools that make our complex AI models accessible and
                  actionable for healthcare professionals.
                </p>
                <div className="space-y-2">
                  <div className="flex items-center gap-2 text-sm text-gray-500">
                    <GraduationCap className="h-4 w-4" />
                ...
                <div className="flex gap-3 pt-2">
                  <Link
                    href="https://github.com/Codingjackking"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-gray-500 hover:text-gray-900"
                  >
                  ...
                  <Link
                    href="https://www.linkedin.com/in/naing-htet/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-gray-500 hover:text-gray-900"
                  >
                  ...
                  <Link
                    href="mailto:naing@multivac.com"
                    className="text-gray-500 hover:text-gray-900"
                  >
                    <Mail className="h-5 w-5" />
                    <span className="sr-only">Email</span>
          ...
          <div className="mt-12">
            <h2 className="text-3xl font-bold mb-6">
              Our Project: Reinforcement Learning for Optimizing Multi-Vaccine
              Distribution
            </h2>
            ...
            <Tabs defaultValue="overview" className="mt-6">
              ...
              <TabsContent value="overview" className="mt-6 space-y-6">
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <p>
                      <strong>Problem:</strong> Static vaccine allocation
                      strategies lack real-time responsiveness.
                    </p>
                    <p>
                      <strong>Goal:</strong> Use reinforcement learning to
                      optimize distribution of COVID-19 and flu vaccines under
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      <div>
                        <h3 className="font-semibold mb-2">
                          Dual Disease Simulation:
                        </h3>
                        <p>COVID-19 + Flu</p>
                      </div>
                      <div>
                        <h3 className="font-semibold mb-2">
                          Dynamic RL-based Allocation at:
                        </h3>
                ...
                <Card>
                  <CardHeader>
                    <CardTitle>
                      Key Literature and Framework Inspiration
                    </CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <ul className="list-disc pl-5 space-y-2">
                      <li>
                        <strong>VacSIM:</strong> RL for COVID-19 vaccine
                        allocation using SEIR + DQN + Contextual Bandits
                      </li>
                      <li>
                        <strong>Nature (2024):</strong> Graph RL integration for
                        vaccine routing over social networks
                      </li>
                      <li>
                        <strong>RL Cloud Logistics:</strong> Cloud-based RL for
                        logistics planning
                      </li>
                    </ul>
                    <p className="font-medium mt-2">
                      Takeaway: RL outperforms heuristics; supports flexible,
              ...
              <TabsContent value="methodology" className="mt-6 space-y-6">
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <p>
                      <strong>Challenge:</strong> Messy, heterogeneous public
                      datasets (COVID, flu, mortality, coverage)
                    </p>
                    ...
                    <ul className="list-disc pl-5 space-y-1">
                      ...
                      <li>
                        Standardize column names (e.g., "Jurisdiction" →
                        "State")
                      </li>
                    ...
                    <ol className="list-decimal pl-5 space-y-1">
                      <li>
                        Select one high-quality .csv per category (x4) for both
                        COVID-19 and flu to reduce merging complexity.
                      </li>
                      <li>
                        Focus on consistency across time granularity, naming
                        conventions, and missing values.
                      </li>
                      <li>
                        Move away from large-scale joins → simplifying
                        downstream processing and synthetic generation.
                      </li>
                    </ol>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <h3 className="font-semibold mb-2">
                      Features for each state include:
                    </h3>
                    ...
                    <div className="mt-4">
                      <p>
                        <strong>Multi-scale design:</strong> National / Region /
                        State features
                      </p>
                      <p>
                        <strong>Data handling:</strong> Synthetic fallback if
                        data missing
                      </p>
                    </div>
                  </CardContent>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div>
                      ...
                      <ul className="list-disc pl-5">
                        ...
                        <li>
                          Flu seasonality & COVID variant boosters factored in
                        </li>
                      </ul>
                    </div>
                    ...
                    <div>
                      <h3 className="font-semibold mb-2">
                        Vaccine RL Environment Design:
                      </h3>
                      <ul className="list-disc pl-5">
                        <li>
                          Custom Gym environment models vaccination dynamics
                          over multiple actions
                        </li>
                        <li>
                          State includes infection, supply, coverage, trust, and
                          disease-specific factors
                        </li>
                        <li>
                          Supports both COVID-19 and flu via modular, shared
                          logic
                        </li>
                      </ul>
                    </div>
                ...
                <Card>
                  ...
                  <CardContent>
                    ...
                    <div className="mt-4 text-sm">
                      ...
                      <p>
                        2) Includes clipping and normalization to avoid
                        instability.
                      </p>
                    </div>
                  </CardContent>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <ul className="list-disc pl-5 space-y-2">
                      <li>
                        <strong>Baseline:</strong> Random agent (to test reward
                        logic)
                      </li>
                      <li>
                    ...
                    <p className="mt-2">
                      CLI interface for testing, with normalization toggle
                    </p>
                  </CardContent>
                </Card>
              </TabsContent>
              ...
              <TabsContent value="results" className="mt-6 space-y-6">
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <p>
                      <strong>Reward curve:</strong> High variance with raw
                      data, smoothed with normalization
                    </p>
                    ...
                    <p className="mt-2">
                      <strong>Challenge:</strong> Feedback loops are asymmetric
                      across regions
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <ul className="list-disc pl-5 space-y-2">
                      ...
                      <li>
                        Distribution network graphs showing optimized routing
                      </li>
                      <li>
                        Dijkstra-based vaccine routing with overlay for hubs
                      </li>
                      <li>
                        Google Maps + React frontend demo with paths & nodes
                      </li>
                    </ul>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <p>
                      <strong>Frontend built in:</strong> React + Google Maps
                      API
                    </p>
                ...
                <Card>
                  ...
                  <CardContent>
                    <ul className="list-disc pl-5 space-y-3">
                      ...
                      <li>
                        Memory bottlenecks (30GB+ with synthetic generation)
                      </li>
                ...
                <Card>
                  ...
                  <CardContent>
                    <ul className="list-disc pl-5 space-y-3">
                      ...
                      <li>
                        Let RL learn routing (vs. Dijkstra/A*) using GNN-based
                        input
                      </li>
                      <li>
                        Dynamic public trust signals based on agent actions
                      </li>
                      <li>
                        Dashboard UI showing simulation metrics per episode
                      </li>
                      <li>Full agent-vs-heuristic performance comparison</li>
                      <li>
                        Test transfer learning between flu and COVID agent
                        policies
                      </li>
                    </ul>
                  </CardContent>
          ...
          <div className="mt-12 text-center">
            ...
            <p className="text-lg text-gray-600 mb-6">
              Interested in learning more about our platform or discussing a
      ...
      <footer className="border-t bg-gray-50">
        <div className="container py-8 text-center text-sm text-gray-500">
          © 2025 MultiVacSIM. All rights reserved.
        </div>
      </footer>
    </div>
  );
